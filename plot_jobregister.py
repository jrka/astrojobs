...
# Only choose academic years between 2003 and 2014 (inclusive), which are complete as of May 2016
...
plt.plot(table1.index,table1['All']/(table1['AIP']*avgAIP),label='All Jobs, using AIP to UMI avg')
plt.legend(loc='best')
plt.xlabel('Academic Year')
